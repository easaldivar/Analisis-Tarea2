// exp1_n_creciente.cpp
// Experimento 1 (Pregunta 2.2)
// n creciente, densidad fija p = 0.3, pesos en [0, 10].
//
// Uso:   ./exp1 <runs> <lower> <upper> <step>
// Ej:    ./exp1 64 10 300 10
// Salida: resultados/base_e1_us.csv, resultados/fw_e1_us.csv
...
int main(int argc, char* argv[]) {
    ...
    const double DENSIDAD = 0.3;   // p = 0.3: balance visibilidad/rendimiento
    ...
    // Archivos de salida
    std::ofstream csv_base("resultados/base_e1_us.csv");
    std::ofstream csv_fw("resultados/fw_e1_us.csv");
    ...
    using Dur   = std::chrono::duration<double, std::micro>;  // microsegundos

    std::cerr << "\033[0;36mExperimento 1: n creciente, p=" << DENSIDAD
    ...
    std::cerr << "\n\n\033[1;32mExperimento 1 completado.\033[0m\n";
    csv_base.close();
    csv_fw.close();
    return 0;
}
